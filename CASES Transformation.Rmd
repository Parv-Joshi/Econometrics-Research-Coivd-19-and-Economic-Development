...
p = ggplot(data, aes(x = x, y = y)) + geom_point()
p + stat_smooth(method = "lm", formula = y ~ x + I(x^2) + I(x^3), color = "blue") + ggtitle("CASES vs. Cubic Transformation of SANITATION")
...
p = ggplot(data, aes(x = x, y = y)) + geom_point()
p + stat_smooth(method = "lm", formula = y ~ x + I(x^2) + I(x^3), color = "blue") + ggtitle("CASES vs. Cubic Transformation of WATER")
